...
func request_VoiceBioService_VectorizeVoiceprints_0(ctx context.Context, marshaler runtime.Marshaler, client extVoicebiov1.VoiceBioServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extVoicebiov1.VectorizeVoiceprintsRequest
		metadata runtime.ServerMetadata
	)
	...
	msg, err := client.VectorizeVoiceprints(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_VoiceBioService_VectorizeVoiceprints_0(ctx context.Context, marshaler runtime.Marshaler, server extVoicebiov1.VoiceBioServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extVoicebiov1.VectorizeVoiceprintsRequest
		metadata runtime.ServerMetadata
	)
	...
	msg, err := server.VectorizeVoiceprints(ctx, &protoReq)
	return msg, metadata, err
}

func request_VoiceBioService_CompareVoiceprints_0(ctx context.Context, marshaler runtime.Marshaler, client extVoicebiov1.VoiceBioServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extVoicebiov1.CompareVoiceprintsRequest
		metadata runtime.ServerMetadata
	)
	if err := marshaler.NewDecoder(req.Body).Decode(&protoReq); err != nil && !errors.Is(err, io.EOF) {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	...
	msg, err := client.CompareVoiceprints(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_VoiceBioService_CompareVoiceprints_0(ctx context.Context, marshaler runtime.Marshaler, server extVoicebiov1.VoiceBioServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq extVoicebiov1.CompareVoiceprintsRequest
		metadata runtime.ServerMetadata
	)
	...
	msg, err := server.CompareVoiceprints(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterVoiceBioServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extVoicebiov1.VoiceBioServiceServer) error {
	...
	mux.Handle(http.MethodPost, pattern_VoiceBioService_VectorizeVoiceprints_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/cobaltspeech.voicebio.v1.VoiceBioService/VectorizeVoiceprints", runtime.WithHTTPPathPattern("/api/voicebio/v1/vectorize-voiceprints"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_VoiceBioService_VectorizeVoiceprints_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_VoiceBioService_VectorizeVoiceprints_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodPost, pattern_VoiceBioService_CompareVoiceprints_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/cobaltspeech.voicebio.v1.VoiceBioService/CompareVoiceprints", runtime.WithHTTPPathPattern("/api/voicebio/v1/compare-voiceprints"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_VoiceBioService_CompareVoiceprints_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_VoiceBioService_CompareVoiceprints_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterVoiceBioServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extVoicebiov1.VoiceBioServiceClient) error {
	...
	mux.Handle(http.MethodPost, pattern_VoiceBioService_VectorizeVoiceprints_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/cobaltspeech.voicebio.v1.VoiceBioService/VectorizeVoiceprints", runtime.WithHTTPPathPattern("/api/voicebio/v1/vectorize-voiceprints"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_VoiceBioService_VectorizeVoiceprints_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle(http.MethodPost, pattern_VoiceBioService_CompareVoiceprints_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/cobaltspeech.voicebio.v1.VoiceBioService/CompareVoiceprints", runtime.WithHTTPPathPattern("/api/voicebio/v1/compare-voiceprints"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_VoiceBioService_CompareVoiceprints_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_VoiceBioService_VectorizeVoiceprints_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "voicebio", "v1", "vectorize-voiceprints"}, ""))
	pattern_VoiceBioService_CompareVoiceprints_0   = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "voicebio", "v1", "compare-voiceprints"}, ""))
)
...
var (
	...
	forward_VoiceBioService_VectorizeVoiceprints_0 = runtime.ForwardResponseMessage
	forward_VoiceBioService_CompareVoiceprints_0   = runtime.ForwardResponseMessage
)
