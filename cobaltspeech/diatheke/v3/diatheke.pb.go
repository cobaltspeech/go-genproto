...
const file_cobaltspeech_diatheke_v3_diatheke_proto_rawDesc = "" +
	"\n" +
	"'cobaltspeech/diatheke/v3/diatheke.proto\x12\x18cobaltspeech.diatheke.v3\x1a#cobaltspeech/chosun/v2/chosun.proto\x1a!cobaltspeech/cubic/v5/cubic.proto\x1a'cobaltspeech/voicegen/v1/voicegen.proto\"\x10\n" +
	"\x0eVersionRequest\"o\n" +
	...
	"\x06models\x18\x01 \x03(\v2#.cobaltspeech.diatheke.v3.ModelInfoR\x06models\"\xc0\x02\n" +
	"\x14CreateSessionRequest\x12\x19\n" +
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12\x1a\n" +
	"\bwakeword\x18\x02 \x01(\tR\bwakeword\x12E\n" +
	"\bmetadata\x18\x03 \x01(\v2).cobaltspeech.diatheke.v3.SessionMetadataR\bmetadata\x12S\n" +
	"\x12input_audio_format\x18\x04 \x01(\v2%.cobaltspeech.diatheke.v3.AudioFormatR\x10inputAudioFormat\x12U\n" +
	"\x13output_audio_format\x18\x05 \x01(\v2%.cobaltspeech.diatheke.v3.AudioFormatR\x11outputAudioFormat\"g\n" +
	"\x15CreateSessionResponse\x12N\n" +
	"\x0esession_output\x18\x01 \x01(\v2'.cobaltspeech.diatheke.v3.SessionOutputR\rsessionOutput\"Z\n" +
	"\x14DeleteSessionRequest\x12B\n" +
	"\n" +
	"token_data\x18\x01 \x01(\v2#.cobaltspeech.diatheke.v3.TokenDataR\ttokenData\"\x17\n" +
	"\x15DeleteSessionResponse\"c\n" +
	"\x14UpdateSessionRequest\x12K\n" +
	"\rsession_input\x18\x01 \x01(\v2&.cobaltspeech.diatheke.v3.SessionInputR\fsessionInput\"g\n" +
	"\x15UpdateSessionResponse\x12N\n" +
	"\x0esession_output\x18\x01 \x01(\v2'.cobaltspeech.diatheke.v3.SessionOutputR\rsessionOutput\"\xed\x01\n" +
	"\x10StreamTTSRequest\x12H\n" +
	"\freply_action\x18\x01 \x01(\v2%.cobaltspeech.diatheke.v3.ReplyActionR\vreplyAction\x129\n" +
	"\x05token\x18\x02 \x01(\v2#.cobaltspeech.diatheke.v3.TokenDataR\x05token\x12T\n" +
	...
	"\fSessionInput\x129\n" +
	"\x05token\x18\x01 \x01(\v2#.cobaltspeech.diatheke.v3.TokenDataR\x05token\x129\n" +
	"\x04text\x18\x02 \x01(\v2#.cobaltspeech.diatheke.v3.TextInputH\x00R\x04text\x127\n" +
	"\x03asr\x18\x03 \x01(\v2#.cobaltspeech.diatheke.v3.ASRResultH\x00R\x03asr\x12;\n" +
	"\x03cmd\x18\x04 \x01(\v2'.cobaltspeech.diatheke.v3.CommandResultH\x00R\x03cmd\x12:\n" +
	"\x05story\x18\x05 \x01(\v2\".cobaltspeech.diatheke.v3.SetStoryH\x00R\x05storyB\a\n" +
	"\x05input\"K\n" +
	"\tTokenData\x12\x12\n" +
	...
	"\x0eout_parameters\x18\x02 \x03(\v2:.cobaltspeech.diatheke.v3.CommandResult.OutParametersEntryR\routParameters\x12\x14\n" +
	...
	"\n" +
	"parameters\x18\x02 \x03(\v22.cobaltspeech.diatheke.v3.SetStory.ParametersEntryR\n" +
	"parameters\x1a=\n" +
	"\x0fParametersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x91\x01\n" +
	"\rSessionOutput\x129\n" +
	"\x05token\x18\x01 \x01(\v2#.cobaltspeech.diatheke.v3.TokenDataR\x05token\x12E\n" +
	"\vaction_list\x18\x02 \x03(\v2$.cobaltspeech.diatheke.v3.ActionDataR\n" +
	"actionList\"\xad\x02\n" +
	"\n" +
	"ActionData\x12C\n" +
	"\x05input\x18\x01 \x01(\v2+.cobaltspeech.diatheke.v3.WaitForUserActionH\x00R\x05input\x12C\n" +
	"\acommand\x18\x02 \x01(\v2'.cobaltspeech.diatheke.v3.CommandActionH\x00R\acommand\x12=\n" +
	"\x05reply\x18\x03 \x01(\v2%.cobaltspeech.diatheke.v3.ReplyActionH\x00R\x05reply\x12L\n" +
	"\n" +
	"transcribe\x18\x04 \x01(\v2*.cobaltspeech.diatheke.v3.TranscribeActionH\x00R\n" +
	"transcribeB\b\n" +
	"\x06action\"_\n" +
	...
	"\x10input_parameters\x18\x02 \x03(\v2<.cobaltspeech.diatheke.v3.CommandAction.InputParametersEntryR\x0finputParameters\x12D\n" +
	"\n" +
	...
	"\x05token\x18\x01 \x01(\v2#.cobaltspeech.diatheke.v3.TokenDataH\x00R\x05token\x12\x16\n" +
	"\x05audio\x18\x02 \x01(\fH\x00R\x05audioB\x06\n" +
	"\x04data\"W\n" +
	"\x11StreamASRResponse\x12B\n" +
	"\n" +
	"asr_result\x18\x01 \x01(\v2#.cobaltspeech.diatheke.v3.ASRResultR\tasrResult\"{\n" +
	...
	"\n" +
	"asr_result\x18\x02 \x01(\v2#.cobaltspeech.diatheke.v3.ASRResultH\x00R\tasrResult\x12S\n" +
	"\x0fwakeword_result\x18\x03 \x01(\v2(.cobaltspeech.diatheke.v3.WakewordResultH\x00R\x0ewakewordResultB\x06\n" +
	"\x04data\"\xa9\x01\n" +
	"\tASRResult\x12\x12\n" +
	...
	"\x06action\x18\x01 \x01(\v2*.cobaltspeech.diatheke.v3.TranscribeActionH\x00R\x06action\x12\x16\n" +
	"\x05audio\x18\x02 \x01(\fH\x00R\x05audioB\x06\n" +
	"\x04data\"\xb4\x01\n" +
	...
	"\x05codec\x18\x04 \x01(\x0e2$.cobaltspeech.diatheke.v3.AudioCodecR\x05codec\x12C\n" +
	"\bencoding\x18\x05 \x01(\x0e2'.cobaltspeech.diatheke.v3.AudioEncodingR\bencoding\x12B\n" +
	"\n" +
	"byte_order\x18\x06 \x01(\x0e2#.cobaltspeech.diatheke.v3.ByteOrderR\tbyteOrder*`\n" +
	"\tByteOrder\x12\x1a\n" +
	...
	"\x0fDiathekeService\x12`\n" +
	"\aVersion\x12(.cobaltspeech.diatheke.v3.VersionRequest\x1a).cobaltspeech.diatheke.v3.VersionResponse\"\x00\x12i\n" +
	"\n" +
	...
	"\x15StreamASRWithPartials\x126.cobaltspeech.diatheke.v3.StreamASRWithPartialsRequest\x1a7.cobaltspeech.diatheke.v3.StreamASRWithPartialsResponse\"\x00(\x010\x01\x12m\n" +
	"\n" +
	"Transcribe\x12+.cobaltspeech.diatheke.v3.TranscribeRequest\x1a,.cobaltspeech.diatheke.v3.TranscribeResponse\"\x00(\x010\x01\x12h\n" +
	"\tStreamTTS\x12*.cobaltspeech.diatheke.v3.StreamTTSRequest\x1a+.cobaltspeech.diatheke.v3.StreamTTSResponse\"\x000\x01B\xf8\x01\n" +
	"\x1ccom.cobaltspeech.diatheke.v3B\rDiathekeProtoP\x01ZGgithub.com/cobaltspeech/go-genproto/cobaltspeech/diatheke/v3;diathekev3\xa2\x02\x03CDX\xaa\x02\x18Cobaltspeech.Diatheke.V3\xca\x02\x18Cobaltspeech\\Diatheke\\V3\xe2\x02$Cobaltspeech\\Diatheke\\V3\\GPBMetadata\xea\x02\x1aCobaltspeech::Diatheke::V3b\x06proto3"
