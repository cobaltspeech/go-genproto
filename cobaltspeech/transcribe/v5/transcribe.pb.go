...
const file_cobaltspeech_transcribe_v5_transcribe_proto_rawDesc = "" +
	"\n" +
	"+cobaltspeech/transcribe/v5/transcribe.proto\x12\x1acobaltspeech.transcribe.v5\"\x10\n" +
	"\x0eVersionRequest\"+\n" +
	"\x0fVersionResponse\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\"\x13\n" +
	"\x11ListModelsRequest\"O\n" +
	"\x12ListModelsResponse\x129\n" +
	"\x06models\x18\x01 \x03(\v2!.cobaltspeech.transcribe.v5.ModelR\x06models\"\xb5\x01\n" +
	"\x19StreamingRecognizeRequest\x12G\n" +
	"\x06config\x18\x01 \x01(\v2-.cobaltspeech.transcribe.v5.RecognitionConfigH\x00R\x06config\x12D\n" +
	"\x05audio\x18\x02 \x01(\v2,.cobaltspeech.transcribe.v5.RecognitionAudioH\x00R\x05audioB\t\n" +
	"\arequest\"\xa7\x01\n" +
	"\x1aStreamingRecognizeResponse\x12E\n" +
	"\x06result\x18\x01 \x01(\v2-.cobaltspeech.transcribe.v5.RecognitionResultR\x06result\x12B\n" +
	"\x05error\x18\x02 \x01(\v2,.cobaltspeech.transcribe.v5.RecognitionErrorR\x05error\"\x8d\x01\n" +
	"\x15CompileContextRequest\x12\x19\n" +
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\x12C\n" +
	"\aphrases\x18\x03 \x03(\v2).cobaltspeech.transcribe.v5.ContextPhraseR\aphrases\"_\n" +
	"\x16CompileContextResponse\x12E\n" +
	"\acontext\x18\x01 \x01(\v2+.cobaltspeech.transcribe.v5.CompiledContextR\acontext\"\xe7\x04\n" +
	"\x11RecognitionConfig\x12\x19\n" +
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12V\n" +
	"\x10audio_format_raw\x18\x02 \x01(\v2*.cobaltspeech.transcribe.v5.AudioFormatRAWH\x00R\x0eaudioFormatRaw\x12e\n" +
	"\x15audio_format_headered\x18\x03 \x01(\x0e2/.cobaltspeech.transcribe.v5.AudioFormatHeaderedH\x00R\x13audioFormatHeadered\x126\n" +
	...
	"\x18enable_confusion_network\x18\a \x01(\bR\x16enableConfusionNetwork\x12K\n" +
	"\bmetadata\x18\b \x01(\v2/.cobaltspeech.transcribe.v5.RecognitionMetadataR\bmetadata\x12H\n" +
	"\acontext\x18\t \x01(\v2..cobaltspeech.transcribe.v5.RecognitionContextR\acontextB\x0e\n" +
	"\faudio_format\"\xf7\x01\n" +
	"\x0eAudioFormatRAW\x12E\n" +
	"\bencoding\x18\x01 \x01(\x0e2).cobaltspeech.transcribe.v5.AudioEncodingR\bencoding\x12\x1b\n" +
	"\tbit_depth\x18\x02 \x01(\rR\bbitDepth\x12D\n" +
	"\n" +
	"byte_order\x18\x03 \x01(\x0e2%.cobaltspeech.transcribe.v5.ByteOrderR\tbyteOrder\x12\x1f\n" +
	...
	"\tcustom_id\x18\x02 \x01(\tR\bcustomId\"]\n" +
	"\x12RecognitionContext\x12G\n" +
	"\bcompiled\x18\x01 \x03(\v2+.cobaltspeech.transcribe.v5.CompiledContextR\bcompiled\"%\n" +
	...
	"\n" +
	"attributes\x18\x03 \x01(\v2+.cobaltspeech.transcribe.v5.ModelAttributesR\n" +
	"attributes\"\xb4\x01\n" +
	"\x0fModelAttributes\x12\x1f\n" +
	"\vsample_rate\x18\x01 \x01(\rR\n" +
	"sampleRate\x12J\n" +
	"\fcontext_info\x18\x02 \x01(\v2'.cobaltspeech.transcribe.v5.ContextInfoR\vcontextInfo\x124\n" +
	...
	"\x16allowed_context_tokens\x18\x02 \x03(\tR\x14allowedContextTokens\"\xfc\x01\n" +
	"\x11RecognitionResult\x12V\n" +
	"\falternatives\x18\x01 \x03(\v22.cobaltspeech.transcribe.v5.RecognitionAlternativeR\falternatives\x12\x1d\n" +
	"\n" +
	"is_partial\x18\x02 \x01(\bR\tisPartial\x12K\n" +
	"\x04cnet\x18\x03 \x01(\v27.cobaltspeech.transcribe.v5.RecognitionConfusionNetworkR\x04cnet\x12#\n" +
	...
	"confidence\x12J\n" +
	"\fword_details\x18\x06 \x01(\v2'.cobaltspeech.transcribe.v5.WordDetailsR\vwordDetails\"\x89\x01\n" +
	"\vWordDetails\x12B\n" +
	"\tformatted\x18\x01 \x03(\v2$.cobaltspeech.transcribe.v5.WordInfoR\tformatted\x126\n" +
	"\x03raw\x18\x02 \x03(\v2$.cobaltspeech.transcribe.v5.WordInfoR\x03raw\"\x83\x01\n" +
	"\bWordInfo\x12\x12\n" +
	...
	"\vduration_ms\x18\x04 \x01(\x04R\n" +
	"durationMs\"e\n" +
	"\x1bRecognitionConfusionNetwork\x12F\n" +
	"\x05links\x18\x01 \x03(\v20.cobaltspeech.transcribe.v5.ConfusionNetworkLinkR\x05links\"\xa0\x01\n" +
	"\x14ConfusionNetworkLink\x12\"\n" +
	"\rstart_time_ms\x18\x01 \x01(\x04R\vstartTimeMs\x12\x1f\n" +
	"\vduration_ms\x18\x02 \x01(\x04R\n" +
	"durationMs\x12C\n" +
	"\x04arcs\x18\x03 \x03(\v2/.cobaltspeech.transcribe.v5.ConfusionNetworkArcR\x04arcs\"\x9e\x01\n" +
	"\x13ConfusionNetworkArc\x12\x12\n" +
	"\x04word\x18\x01 \x01(\tR\x04word\x12\x1e\n" +
	"\n" +
	"confidence\x18\x02 \x01(\x01R\n" +
	"confidence\x12S\n" +
	"\bfeatures\x18\x03 \x01(\v27.cobaltspeech.transcribe.v5.ConfusionNetworkArcFeaturesR\bfeatures\"\xc5\x01\n" +
	"\x1bConfusionNetworkArcFeatures\x12g\n" +
	"\n" +
	"confidence\x18\x01 \x03(\v2G.cobaltspeech.transcribe.v5.ConfusionNetworkArcFeatures.ConfidenceEntryR\n" +
	"confidence\x1a=\n" +
	...
	"\x1eAUDIO_FORMAT_HEADERED_OGG_OPUS\x10\x042\xef\x03\n" +
	"\x11TranscribeService\x12d\n" +
	"\aVersion\x12*.cobaltspeech.transcribe.v5.VersionRequest\x1a+.cobaltspeech.transcribe.v5.VersionResponse\"\x00\x12m\n" +
	"\n" +
	...
	"\x12StreamingRecognize\x125.cobaltspeech.transcribe.v5.StreamingRecognizeRequest\x1a6.cobaltspeech.transcribe.v5.StreamingRecognizeResponse\"\x00(\x010\x01\x12y\n" +
	"\x0eCompileContext\x121.cobaltspeech.transcribe.v5.CompileContextRequest\x1a2.cobaltspeech.transcribe.v5.CompileContextResponse\"\x00B\x88\x02\n" +
	"\x1ecom.cobaltspeech.transcribe.v5B\x0fTranscribeProtoP\x01ZKgithub.com/cobaltspeech/go-genproto/cobaltspeech/transcribe/v5;transcribev5\xa2\x02\x03CTX\xaa\x02\x1aCobaltspeech.Transcribe.V5\xca\x02\x1aCobaltspeech\\Transcribe\\V5\xe2\x02&Cobaltspeech\\Transcribe\\V5\\GPBMetadata\xea\x02\x1cCobaltspeech::Transcribe::V5b\x06proto3"
