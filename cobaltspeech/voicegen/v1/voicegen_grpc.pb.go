...
type VoiceGenServiceClient interface {
	...
	StreamingSynthesize(ctx context.Context, in *StreamingSynthesizeRequest, opts ...grpc.CallOption) (VoiceGenService_StreamingSynthesizeClient, error)
}
...
func (c *voiceGenServiceClient) Version(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, VoiceGenService_Version_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *voiceGenServiceClient) ListModels(ctx context.Context, in *ListModelsRequest, opts ...grpc.CallOption) (*ListModelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, VoiceGenService_ListModels_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *voiceGenServiceClient) StreamingSynthesize(ctx context.Context, in *StreamingSynthesizeRequest, opts ...grpc.CallOption) (VoiceGenService_StreamingSynthesizeClient, error) {
	stream, err := c.cc.NewStream(ctx, &VoiceGenService_ServiceDesc.Streams[0], VoiceGenService_StreamingSynthesize_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &voiceGenServiceStreamingSynthesizeClient{stream}
...
type VoiceGenService_StreamingSynthesizeClient interface {
	Recv() (*StreamingSynthesizeResponse, error)
	grpc.ClientStream
}

type voiceGenServiceStreamingSynthesizeClient struct {
	grpc.ClientStream
}

func (x *voiceGenServiceStreamingSynthesizeClient) Recv() (*StreamingSynthesizeResponse, error) {
...
type VoiceGenServiceServer interface {
	...
	// method is only available via GRPC and not via HTTP+JSON. However, a
	// web browser may use websockets to use this service.
	StreamingSynthesize(*StreamingSynthesizeRequest, VoiceGenService_StreamingSynthesizeServer) error
	mustEmbedUnimplementedVoiceGenServiceServer()
}

// UnimplementedVoiceGenServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedVoiceGenServiceServer) StreamingSynthesize(*StreamingSynthesizeRequest, VoiceGenService_StreamingSynthesizeServer) error {
...
func _VoiceGenService_StreamingSynthesize_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(VoiceGenServiceServer).StreamingSynthesize(m, &voiceGenServiceStreamingSynthesizeServer{stream})
}

type VoiceGenService_StreamingSynthesizeServer interface {
	Send(*StreamingSynthesizeResponse) error
	grpc.ServerStream
}

type voiceGenServiceStreamingSynthesizeServer struct {
	grpc.ServerStream
}

func (x *voiceGenServiceStreamingSynthesizeServer) Send(m *StreamingSynthesizeResponse) error {
