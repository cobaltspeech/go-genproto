...
func (c *bluehengeServiceClient) StreamASR(ctx context.Context, opts ...grpc.CallOption) (BluehengeService_StreamASRClient, error) {
	...
	x := &bluehengeServiceStreamASRClient{ClientStream: stream}
	return x, nil
}
...
func (c *bluehengeServiceClient) StreamTTS(ctx context.Context, in *StreamTTSRequest, opts ...grpc.CallOption) (BluehengeService_StreamTTSClient, error) {
	...
	x := &bluehengeServiceStreamTTSClient{ClientStream: stream}
...
func (c *bluehengeServiceClient) Transcribe(ctx context.Context, opts ...grpc.CallOption) (BluehengeService_TranscribeClient, error) {
	...
	x := &bluehengeServiceTranscribeClient{ClientStream: stream}
	return x, nil
}
...
func (c *bluehengeServiceClient) GetProcedures(ctx context.Context, in *GetProceduresRequest, opts ...grpc.CallOption) (*GetProceduresResponse, error) {
	...
	err := c.cc.Invoke(ctx, BluehengeService_GetProcedures_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bluehengeServiceClient) GetEntityImage(ctx context.Context, in *GetEntityImageRequest, opts ...grpc.CallOption) (*GetEntityImageResponse, error) {
	...
	err := c.cc.Invoke(ctx, BluehengeService_GetEntityImage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bluehengeServiceClient) GetImage(ctx context.Context, in *GetImageRequest, opts ...grpc.CallOption) (BluehengeService_GetImageClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BluehengeService_ServiceDesc.Streams[3], BluehengeService_GetImage_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &bluehengeServiceGetImageClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _BluehengeService_StreamASR_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BluehengeServiceServer).StreamASR(&bluehengeServiceStreamASRServer{ServerStream: stream})
}
...
func _BluehengeService_StreamTTS_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BluehengeServiceServer).StreamTTS(m, &bluehengeServiceStreamTTSServer{ServerStream: stream})
}
...
func _BluehengeService_Transcribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BluehengeServiceServer).Transcribe(&bluehengeServiceTranscribeServer{ServerStream: stream})
}
...
func _BluehengeService_GetImage_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BluehengeServiceServer).GetImage(m, &bluehengeServiceGetImageServer{ServerStream: stream})
}
