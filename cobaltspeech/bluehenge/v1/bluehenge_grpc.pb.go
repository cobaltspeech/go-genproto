...
func (c *bluehengeServiceClient) GetImage(ctx context.Context, in *GetImageRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetImageResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BluehengeService_GetImageClient = grpc.ServerStreamingClient[GetImageResponse]
...
func (UnimplementedBluehengeServiceServer) GetProcedures(context.Context, *GetProceduresRequest) (*GetProceduresResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProcedures not implemented")
}
...
func (UnimplementedBluehengeServiceServer) GetEntityImage(context.Context, *GetEntityImageRequest) (*GetEntityImageResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetEntityImage not implemented")
}
func (UnimplementedBluehengeServiceServer) GetImage(*GetImageRequest, grpc.ServerStreamingServer[GetImageResponse]) error {
...
func RegisterBluehengeServiceServer(s grpc.ServiceRegistrar, srv BluehengeServiceServer) {
	// If the following call panics, it indicates UnimplementedBluehengeServiceServer was
...
func _BluehengeService_GetImage_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BluehengeServiceServer).GetImage(m, &grpc.GenericServerStream[GetImageRequest, GetImageResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BluehengeService_GetImageServer = grpc.ServerStreamingServer[GetImageResponse]
