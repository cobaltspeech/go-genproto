...
const file_cobaltspeech_bluehenge_v2_bluehenge_proto_rawDesc = "" +
	"\n" +
	")cobaltspeech/bluehenge/v2/bluehenge.proto\x12\x19cobaltspeech.bluehenge.v2\x1a'cobaltspeech/diatheke/v3/diatheke.proto\"\x10\n" +
	"\x0eVersionRequest\"\xfe\x01\n" +
	"\x0fVersionResponse\x12\x1c\n" +
	"\tbluehenge\x18\x01 \x01(\tR\tbluehenge\x12e\n" +
	"\x19diatheke_version_response\x18\x02 \x01(\v2).cobaltspeech.diatheke.v3.VersionResponseR\x17diathekeVersionResponse\x12.\n" +
	"\x13source_data_version\x18\x03 \x01(\tR\x11sourceDataVersion\x126\n" +
	...
	"\x1bdiatheke_stream_tts_request\x18\x01 \x01(\v2*.cobaltspeech.diatheke.v3.StreamTTSRequestR\x18diathekeStreamTtsRequest\")\n" +
	"\x11StreamTTSResponse\x12\x14\n" +
	"\x05audio\x18\x01 \x01(\fR\x05audio\"\x80\x01\n" +
	...
	"\x1cdiatheke_transcribe_response\x18\x01 \x01(\v2,.cobaltspeech.diatheke.v3.TranscribeResponseR\x1adiathekeTranscribeResponse\"\x17\n" +
	"\x15ListProceduresRequest\"b\n" +
	"\x16ListProceduresResponse\x12H\n" +
	"\n" +
	"procedures\x18\x01 \x03(\v2(.cobaltspeech.bluehenge.v2.ProcedureLiteR\n" +
	"procedures\"\x12\n" +
	"\x10ListTreesRequest\"N\n" +
	"\x11ListTreesResponse\x129\n" +
	"\x05trees\x18\x01 \x03(\v2#.cobaltspeech.bluehenge.v2.TreeLiteR\x05trees\")\n" +
	"\x13GetProcedureRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"Z\n" +
	"\x14GetProcedureResponse\x12B\n" +
	"\tprocedure\x18\x01 \x01(\v2$.cobaltspeech.bluehenge.v2.ProcedureR\tprocedure\" \n" +
	"\x0eGetTaskRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"F\n" +
	"\x0fGetTaskResponse\x123\n" +
	"\x04task\x18\x01 \x01(\v2\x1f.cobaltspeech.bluehenge.v2.TaskR\x04task\"$\n" +
	"\x0eGetTreeRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"F\n" +
	"\x0fGetTreeResponse\x123\n" +
	"\x04tree\x18\x01 \x01(\v2\x1f.cobaltspeech.bluehenge.v2.TreeR\x04tree\"\xc0\x01\n" +
	"\rProcedureLite\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12%\n" +
	"\x0eprocedure_name\x18\x02 \x01(\tR\rprocedureName\x12\x12\n" +
	"\x04page\x18\x03 \x01(\tR\x04page\x12)\n" +
	"\x10procedure_number\x18\x04 \x01(\tR\x0fprocedureNumber\x129\n" +
	"\x05tasks\x18\x05 \x03(\v2#.cobaltspeech.bluehenge.v2.TaskLiteR\x05tasks\"X\n" +
	"\bTaskLite\x12\x0e\n" +
	...
	"\bTreeLite\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\ttree_name\x18\x02 \x01(\tR\btreeName\x12\x1f\n" +
	"\vtree_number\x18\x03 \x01(\tR\n" +
	"treeNumber\"\xfa\x01\n" +
	"\tProcedure\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12)\n" +
	"\x10procedure_number\x18\x03 \x01(\tR\x0fprocedureNumber\x12)\n" +
	"\x10additional_names\x18\x04 \x03(\tR\x0fadditionalNames\x12<\n" +
	"\x1aprerequisites_warning_text\x18\x05 \x01(\tR\x18prerequisitesWarningText\x125\n" +
	"\x05tasks\x18\x06 \x03(\v2\x1f.cobaltspeech.bluehenge.v2.TaskR\x05tasks\"\xdd\x01\n" +
	"\x04Task\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\ttask_name\x18\x02 \x01(\tR\btaskName\x12\x1f\n" +
	"\vtask_number\x18\x03 \x01(\tR\n" +
	...
	"\x05steps\x18\x06 \x03(\v2#.cobaltspeech.bluehenge.v2.StepDataR\x05steps\"\xdc\x02\n" +
	"\bStepData\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12)\n" +
	...
	"\fsegment_type\x18\b \x01(\tR\vsegmentType\x12\x14\n" +
	"\x05image\x18\t \x03(\tR\x05image\x12\x14\n" +
	"\x05parts\x18\v \x03(\tR\x05parts\x125\n" +
	"\x05notes\x18\n" +
	" \x03(\v2\x1f.cobaltspeech.bluehenge.v2.NoteR\x05notes\"\xf8\x01\n" +
	"\x04Tree\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\ttree_name\x18\x02 \x01(\tR\btreeName\x12\x1f\n" +
	"\vtree_number\x18\x03 \x01(\tR\n" +
	"treeNumber\x12)\n" +
	"\x10additional_names\x18\x04 \x03(\tR\x0fadditionalNames\x12<\n" +
	"\x1aprerequisites_warning_text\x18\x05 \x01(\tR\x18prerequisitesWarningText\x129\n" +
	"\x05nodes\x18\x06 \x03(\v2#.cobaltspeech.bluehenge.v2.TreeNodeR\x05nodes\"\x8c\x02\n" +
	"\bTreeNode\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1d\n" +
	"\n" +
	"node_index\x18\x02 \x01(\tR\tnodeIndex\x12)\n" +
	"\x10instruction_text\x18\x03 \x01(\tR\x0finstructionText\x12C\n" +
	"\aoptions\x18\x04 \x03(\v2).cobaltspeech.bluehenge.v2.TroubleOptionsR\aoptions\x12\x14\n" +
	"\x05image\x18\x05 \x03(\tR\x05image\x12\x14\n" +
	"\x05parts\x18\x06 \x03(\tR\x05parts\x125\n" +
	"\x05notes\x18\a \x03(\v2\x1f.cobaltspeech.bluehenge.v2.NoteR\x05notes\"P\n" +
	...
	"\bentities\x18\x01 \x03(\v2!.cobaltspeech.bluehenge.v2.EntityR\bentities\"R\n" +
	" GetExtractionRelationshipRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\brelation\x18\x02 \x01(\tR\brelation\"j\n" +
	"!GetExtractionRelationshipResponse\x12E\n" +
	"\n" +
	"extraction\x18\x01 \x01(\v2%.cobaltspeech.bluehenge.v2.ExtractionR\n" +
	"extraction\"\xd5\x01\n" +
	"\n" +
	"Extraction\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12;\n" +
	"\asubject\x18\x02 \x01(\v2!.cobaltspeech.bluehenge.v2.EntityR\asubject\x129\n" +
	"\x06object\x18\x03 \x01(\v2!.cobaltspeech.bluehenge.v2.EntityR\x06object\x12?\n" +
	"\brelation\x18\x04 \x01(\v2#.cobaltspeech.bluehenge.v2.RelationR\brelation\"&\n" +
	"\x10GetEntityRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"N\n" +
	"\x11GetEntityResponse\x129\n" +
	"\x06entity\x18\x01 \x01(\v2!.cobaltspeech.bluehenge.v2.EntityR\x06entity\"\xbe\x01\n" +
	"\x06Entity\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12>\n" +
	"\bmentions\x18\x02 \x01(\v2\".cobaltspeech.bluehenge.v2.MentionR\bmentions\x12\x12\n" +
	...
	"\bRelation\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12>\n" +
	"\bmentions\x18\x02 \x01(\v2\".cobaltspeech.bluehenge.v2.MentionR\bmentions\"\x1d\n" +
	"\aMention\x12\x12\n" +
	"\x04text\x18\x01 \x03(\tR\x04text\"+\n" +
	"\x19GetEntityImageDataRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"j\n" +
	"\x1aGetEntityImageDataResponse\x12L\n" +
	"\x0fimage_data_list\x18\x01 \x03(\v2$.cobaltspeech.bluehenge.v2.ImageDataR\rimageDataList\"R\n" +
	"\tImageData\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\thttp_path\x18\x02 \x01(\tR\bhttpPath\x12\x18\n" +
	"\acaption\x18\x03 \x01(\tR\acaption2\x91\x10\n" +
	"\x10BluehengeService\x12b\n" +
	"\aVersion\x12).cobaltspeech.bluehenge.v2.VersionRequest\x1a*.cobaltspeech.bluehenge.v2.VersionResponse\"\x00\x12k\n" +
	"\n" +
	"ListModels\x12,.cobaltspeech.bluehenge.v2.ListModelsRequest\x1a-.cobaltspeech.bluehenge.v2.ListModelsResponse\"\x00\x12t\n" +
	"\rCreateSession\x12/.cobaltspeech.bluehenge.v2.CreateSessionRequest\x1a0.cobaltspeech.bluehenge.v2.CreateSessionResponse\"\x00\x12t\n" +
	"\rDeleteSession\x12/.cobaltspeech.bluehenge.v2.DeleteSessionRequest\x1a0.cobaltspeech.bluehenge.v2.DeleteSessionResponse\"\x00\x12t\n" +
	"\rUpdateSession\x12/.cobaltspeech.bluehenge.v2.UpdateSessionRequest\x1a0.cobaltspeech.bluehenge.v2.UpdateSessionResponse\"\x00\x12j\n" +
	"\tStreamASR\x12+.cobaltspeech.bluehenge.v2.StreamASRRequest\x1a,.cobaltspeech.bluehenge.v2.StreamASRResponse\"\x00(\x01\x12j\n" +
	"\tStreamTTS\x12+.cobaltspeech.bluehenge.v2.StreamTTSRequest\x1a,.cobaltspeech.bluehenge.v2.StreamTTSResponse\"\x000\x01\x12o\n" +
	"\n" +
	"Transcribe\x12,.cobaltspeech.bluehenge.v2.TranscribeRequest\x1a-.cobaltspeech.bluehenge.v2.TranscribeResponse\"\x00(\x010\x01\x12w\n" +
	"\x0eListProcedures\x120.cobaltspeech.bluehenge.v2.ListProceduresRequest\x1a1.cobaltspeech.bluehenge.v2.ListProceduresResponse\"\x00\x12h\n" +
	"\tListTrees\x12+.cobaltspeech.bluehenge.v2.ListTreesRequest\x1a,.cobaltspeech.bluehenge.v2.ListTreesResponse\"\x00\x12q\n" +
	"\fListEntities\x12..cobaltspeech.bluehenge.v2.ListEntitiesRequest\x1a/.cobaltspeech.bluehenge.v2.ListEntitiesResponse\"\x00\x12q\n" +
	"\fGetProcedure\x12..cobaltspeech.bluehenge.v2.GetProcedureRequest\x1a/.cobaltspeech.bluehenge.v2.GetProcedureResponse\"\x00\x12b\n" +
	"\aGetTask\x12).cobaltspeech.bluehenge.v2.GetTaskRequest\x1a*.cobaltspeech.bluehenge.v2.GetTaskResponse\"\x00\x12b\n" +
	"\aGetTree\x12).cobaltspeech.bluehenge.v2.GetTreeRequest\x1a*.cobaltspeech.bluehenge.v2.GetTreeResponse\"\x00\x12e\n" +
	"\bSaveNote\x12*.cobaltspeech.bluehenge.v2.SaveNoteRequest\x1a+.cobaltspeech.bluehenge.v2.SaveNoteResponse\"\x00\x12\x98\x01\n" +
	...
	"\x12GetEntityImageData\x124.cobaltspeech.bluehenge.v2.GetEntityImageDataRequest\x1a5.cobaltspeech.bluehenge.v2.GetEntityImageDataResponse\"\x00B\x80\x02\n" +
	"\x1dcom.cobaltspeech.bluehenge.v2B\x0eBluehengeProtoP\x01ZIgithub.com/cobaltspeech/go-genproto/cobaltspeech/bluehenge/v2;bluehengev2\xa2\x02\x03CBX\xaa\x02\x19Cobaltspeech.Bluehenge.V2\xca\x02\x19Cobaltspeech\\Bluehenge\\V2\xe2\x02%Cobaltspeech\\Bluehenge\\V2\\GPBMetadata\xea\x02\x1bCobaltspeech::Bluehenge::V2b\x06proto3"
