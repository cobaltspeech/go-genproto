...
const file_cobaltspeech_cubic_v1_cubic_proto_rawDesc = "" +
	"\n" +
	"!cobaltspeech/cubic/v1/cubic.proto\x12\x12cobaltspeech.cubic\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x13\n" +
	"\x11ListModelsRequest\"\x8d\x01\n" +
	"\x10RecognizeRequest\x12=\n" +
	"\x06config\x18\x01 \x01(\v2%.cobaltspeech.cubic.RecognitionConfigR\x06config\x12:\n" +
	"\x05audio\x18\x02 \x01(\v2$.cobaltspeech.cubic.RecognitionAudioR\x05audio\"\xa5\x01\n" +
	"\x19StreamingRecognizeRequest\x12?\n" +
	"\x06config\x18\x01 \x01(\v2%.cobaltspeech.cubic.RecognitionConfigH\x00R\x06config\x12<\n" +
	"\x05audio\x18\x02 \x01(\v2$.cobaltspeech.cubic.RecognitionAudioH\x00R\x05audioB\t\n" +
	"\arequest\"\x85\x01\n" +
	"\x15CompileContextRequest\x12\x19\n" +
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\x12;\n" +
	"\aphrases\x18\x03 \x03(\v2!.cobaltspeech.cubic.ContextPhraseR\aphrases\"?\n" +
	"\x0fVersionResponse\x12\x14\n" +
	"\x05cubic\x18\x01 \x01(\tR\x05cubic\x12\x16\n" +
	"\x06server\x18\x02 \x01(\tR\x06server\"G\n" +
	"\x12ListModelsResponse\x121\n" +
	"\x06models\x18\x01 \x03(\v2\x19.cobaltspeech.cubic.ModelR\x06models\"V\n" +
	"\x13RecognitionResponse\x12?\n" +
	"\aresults\x18\x01 \x03(\v2%.cobaltspeech.cubic.RecognitionResultR\aresults\"W\n" +
	"\x16CompileContextResponse\x12=\n" +
	"\acontext\x18\x01 \x01(\v2#.cobaltspeech.cubic.CompiledContextR\acontext\"\xbb\x05\n" +
	"\x11RecognitionConfig\x12\x19\n" +
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12U\n" +
	"\x0eaudio_encoding\x18\x02 \x01(\x0e2..cobaltspeech.cubic.RecognitionConfig.EncodingR\raudioEncoding\x12<\n" +
	"\fidle_timeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\vidleTimeout\x127\n" +
	"\x18enable_word_time_offsets\x18\x04 \x01(\bR\x15enableWordTimeOffsets\x124\n" +
	"\x16enable_word_confidence\x18\x05 \x01(\bR\x14enableWordConfidence\x122\n" +
	"\x15enable_raw_transcript\x18\x06 \x01(\bR\x13enableRawTranscript\x128\n" +
	"\x18enable_confusion_network\x18\a \x01(\bR\x16enableConfusionNetwork\x12%\n" +
	"\x0eaudio_channels\x18\b \x03(\rR\raudioChannels\x12C\n" +
	"\bmetadata\x18\t \x01(\v2'.cobaltspeech.cubic.RecognitionMetadataR\bmetadata\x12@\n" +
	"\acontext\x18\n" +
	" \x01(\v2&.cobaltspeech.cubic.RecognitionContextR\acontext\"k\n" +
	"\bEncoding\x12\x10\n" +
	"\fRAW_LINEAR16\x10\x00\x12\a\n" +
	"\x03WAV\x10\x01\x12\a\n" +
	"\x03MP3\x10\x02\x12\b\n" +
	"\x04FLAC\x10\x03\x12\v\n" +
	"\aVOX8000\x10\x04\x12\f\n" +
	"\bULAW8000\x10\x05\x12\f\n" +
	"\bALAW8000\x10\x06\x12\b\n" +
	"\x04OPUS\x10\a\">\n" +
	"\x13RecognitionMetadata\x12'\n" +
	"\x0fcustom_metadata\x18\x01 \x01(\tR\x0ecustomMetadata\"U\n" +
	"\x12RecognitionContext\x12?\n" +
	"\bcompiled\x18\x01 \x03(\v2#.cobaltspeech.cubic.CompiledContextR\bcompiled\"%\n" +
	...
	"\n" +
	"attributes\x18\x03 \x01(\v2#.cobaltspeech.cubic.ModelAttributesR\n" +
	"attributes\"v\n" +
	"\x0fModelAttributes\x12\x1f\n" +
	"\vsample_rate\x18\x01 \x01(\rR\n" +
	"sampleRate\x12B\n" +
	"\fcontext_info\x18\x02 \x01(\v2\x1f.cobaltspeech.cubic.ContextInfoR\vcontextInfo\"n\n" +
	"\vContextInfo\x12)\n" +
	"\x10supports_context\x18\x01 \x01(\bR\x0fsupportsContext\x124\n" +
	"\x16allowed_context_tokens\x18\x02 \x03(\tR\x14allowedContextTokens\"\xec\x01\n" +
	"\x11RecognitionResult\x12N\n" +
	"\falternatives\x18\x01 \x03(\v2*.cobaltspeech.cubic.RecognitionAlternativeR\falternatives\x12\x1d\n" +
	"\n" +
	"is_partial\x18\x02 \x01(\bR\tisPartial\x12C\n" +
	"\x04cnet\x18\x03 \x01(\v2/.cobaltspeech.cubic.RecognitionConfusionNetworkR\x04cnet\x12#\n" +
	"\raudio_channel\x18\x04 \x01(\rR\faudioChannel\"\xdf\x02\n" +
	...
	"confidence\x122\n" +
	"\x05words\x18\x03 \x03(\v2\x1c.cobaltspeech.cubic.WordInfoR\x05words\x129\n" +
	"\traw_words\x18\a \x03(\v2\x1c.cobaltspeech.cubic.WordInfoR\brawWords\x128\n" +
	"\n" +
	"start_time\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\tstartTime\x125\n" +
	"\bduration\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\bduration\"\xaf\x01\n" +
	"\bWordInfo\x12\x12\n" +
	...
	"confidence\x128\n" +
	"\n" +
	"start_time\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\tstartTime\x125\n" +
	"\bduration\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\bduration\"]\n" +
	"\x1bRecognitionConfusionNetwork\x12>\n" +
	"\x05links\x18\x01 \x03(\v2(.cobaltspeech.cubic.ConfusionNetworkLinkR\x05links\"\xc4\x01\n" +
	"\x14ConfusionNetworkLink\x128\n" +
	"\n" +
	"start_time\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\tstartTime\x125\n" +
	"\bduration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\bduration\x12;\n" +
	"\x04arcs\x18\x03 \x03(\v2'.cobaltspeech.cubic.ConfusionNetworkArcR\x04arcs\"I\n" +
	...
	"confidence2\xed\x03\n" +
	"\x05Cubic\x12H\n" +
	"\aVersion\x12\x16.google.protobuf.Empty\x1a#.cobaltspeech.cubic.VersionResponse\"\x00\x12]\n" +
	"\n" +
	...
	"\x12StreamingRecognize\x12-.cobaltspeech.cubic.StreamingRecognizeRequest\x1a'.cobaltspeech.cubic.RecognitionResponse\"\x00(\x010\x01\x12i\n" +
	"\x0eCompileContext\x12).cobaltspeech.cubic.CompileContextRequest\x1a*.cobaltspeech.cubic.CompileContextResponse\"\x00B\xc8\x01\n" +
	"\x16com.cobaltspeech.cubicB\n" +
	"CubicProtoP\x01Z9github.com/cobaltspeech/go-genproto/cobaltspeech/cubic/v1\xa2\x02\x03CCX\xaa\x02\x12Cobaltspeech.Cubic\xca\x02\x12Cobaltspeech\\Cubic\xe2\x02\x1eCobaltspeech\\Cubic\\GPBMetadata\xea\x02\x13Cobaltspeech::Cubicb\x06proto3"
