...
const (
	CubicService_Version_FullMethodName            = "/cobaltspeech.cubic.v5.CubicService/Version"
	CubicService_ListModels_FullMethodName         = "/cobaltspeech.cubic.v5.CubicService/ListModels"
	CubicService_StreamingRecognize_FullMethodName = "/cobaltspeech.cubic.v5.CubicService/StreamingRecognize"
	CubicService_CompileContext_FullMethodName     = "/cobaltspeech.cubic.v5.CubicService/CompileContext"
)
...
func (c *cubicServiceClient) Version(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, CubicService_Version_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cubicServiceClient) ListModels(ctx context.Context, in *ListModelsRequest, opts ...grpc.CallOption) (*ListModelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CubicService_ListModels_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cubicServiceClient) StreamingRecognize(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[StreamingRecognizeRequest, StreamingRecognizeResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CubicService_ServiceDesc.Streams[0], CubicService_StreamingRecognize_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type CubicService_StreamingRecognizeClient = grpc.BidiStreamingClient[StreamingRecognizeRequest, StreamingRecognizeResponse]
...
func (c *cubicServiceClient) CompileContext(ctx context.Context, in *CompileContextRequest, opts ...grpc.CallOption) (*CompileContextResponse, error) {
	...
	err := c.cc.Invoke(ctx, CubicService_CompileContext_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCubicServiceServer must be embedded to have
...
func (UnimplementedCubicServiceServer) StreamingRecognize(grpc.BidiStreamingServer[StreamingRecognizeRequest, StreamingRecognizeResponse]) error {
...
func (UnimplementedCubicServiceServer) testEmbeddedByValue()                      {}
...
func RegisterCubicServiceServer(s grpc.ServiceRegistrar, srv CubicServiceServer) {
	// If the following call pancis, it indicates UnimplementedCubicServiceServer was
...
func _CubicService_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CubicService_Version_FullMethodName,
	}
...
func _CubicService_ListModels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CubicService_ListModels_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CubicService_StreamingRecognize_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CubicServiceServer).StreamingRecognize(&grpc.GenericServerStream[StreamingRecognizeRequest, StreamingRecognizeResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CubicService_StreamingRecognizeServer = grpc.BidiStreamingServer[StreamingRecognizeRequest, StreamingRecognizeResponse]
...
func _CubicService_CompileContext_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CubicService_CompileContext_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
