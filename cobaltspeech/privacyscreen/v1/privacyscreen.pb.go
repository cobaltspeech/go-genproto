...
var file_cobaltspeech_privacyscreen_v1_privacyscreen_proto_rawDesc = string([]byte{
...
var (
	...
	file_cobaltspeech_privacyscreen_v1_privacyscreen_proto_rawDescData []byte
)
...
func file_cobaltspeech_privacyscreen_v1_privacyscreen_proto_rawDescGZIP() []byte {
	file_cobaltspeech_privacyscreen_v1_privacyscreen_proto_rawDescOnce.Do(func() {
		file_cobaltspeech_privacyscreen_v1_privacyscreen_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cobaltspeech_privacyscreen_v1_privacyscreen_proto_rawDesc), len(file_cobaltspeech_privacyscreen_v1_privacyscreen_proto_rawDesc)))
	})
...
func file_cobaltspeech_privacyscreen_v1_privacyscreen_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cobaltspeech_privacyscreen_v1_privacyscreen_proto_rawDesc), len(file_cobaltspeech_privacyscreen_v1_privacyscreen_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   1,
