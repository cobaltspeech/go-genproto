...
const file_cobaltspeech_privacyscreen_v1_privacyscreen_proto_rawDesc = "" +
	"\n" +
	"1cobaltspeech/privacyscreen/v1/privacyscreen.proto\x12\x1dcobaltspeech.privacyscreen.v1\"\x10\n" +
	"\x0eVersionRequest\"+\n" +
	"\x0fVersionResponse\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\"\x13\n" +
	"\x11ListModelsRequest\"V\n" +
	"\x12ListModelsResponse\x12@\n" +
	"\x06models\x18\x01 \x03(\v2(.cobaltspeech.privacyscreen.v1.ModelInfoR\x06models\"o\n" +
	"\x11RedactTextRequest\x12F\n" +
	"\x06config\x18\x01 \x01(\v2..cobaltspeech.privacyscreen.v1.RedactionConfigR\x06config\x12\x12\n" +
	"\x04text\x18\x02 \x01(\tR\x04text\"\x7f\n" +
	"\x12RedactTextResponse\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12U\n" +
	"\x0fredacted_tokens\x18\x02 \x03(\v2,.cobaltspeech.privacyscreen.v1.RedactedTokenR\x0eredactedTokens\"\xac\x01\n" +
	"\x17RedactTranscriptRequest\x12F\n" +
	"\x06config\x18\x01 \x01(\v2..cobaltspeech.privacyscreen.v1.RedactionConfigR\x06config\x12I\n" +
	"\n" +
	"transcript\x18\x02 \x01(\v2).cobaltspeech.privacyscreen.v1.TranscriptR\n" +
	"transcript\"e\n" +
	"\x18RedactTranscriptResponse\x12I\n" +
	"\n" +
	"transcript\x18\x01 \x01(\v2).cobaltspeech.privacyscreen.v1.TranscriptR\n" +
	"transcript\"\xa2\x01\n" +
	"&StreamingRedactTranscribedAudioRequest\x12U\n" +
	"\x06config\x18\x01 \x01(\v2;.cobaltspeech.privacyscreen.v1.RedactTranscribedAudioConfigH\x00R\x06config\x12\x16\n" +
	"\x05audio\x18\x02 \x01(\fH\x00R\x05audioB\t\n" +
	"\arequest\"\x95\x01\n" +
	"'StreamingRedactTranscribedAudioResponse\x12H\n" +
	"\tutterance\x18\x01 \x01(\v2(.cobaltspeech.privacyscreen.v1.UtteranceH\x00R\tutterance\x12\x16\n" +
	"\x05audio\x18\x02 \x01(\fH\x00R\x05audioB\b\n" +
	"\x06result\"\x9c\x01\n" +
	"#StreamingTranscribeAndRedactRequest\x12R\n" +
	"\x06config\x18\x01 \x01(\v28.cobaltspeech.privacyscreen.v1.TranscribeAndRedactConfigH\x00R\x06config\x12\x16\n" +
	"\x05audio\x18\x02 \x01(\fH\x00R\x05audioB\t\n" +
	"\arequest\"\xa5\x01\n" +
	"$StreamingTranscribeAndRedactResponse\x12[\n" +
	"\tutterance\x18\x01 \x01(\v2;.cobaltspeech.privacyscreen.v1.TranscribeAndRedactUtteranceH\x00R\tutterance\x12\x16\n" +
	"\x05audio\x18\x02 \x01(\fH\x00R\x05audioB\b\n" +
	"\x06result\"\\\n" +
	"\tModelInfo\x12\x0e\n" +
	...
	"\x10redaction_config\x18\x01 \x01(\v2..cobaltspeech.privacyscreen.v1.RedactionConfigR\x0fredactionConfig\x12I\n" +
	"\n" +
	"transcript\x18\x02 \x01(\v2).cobaltspeech.privacyscreen.v1.TranscriptR\n" +
	"transcript\"\xb8\x01\n" +
	"\x19TranscribeAndRedactConfig\x12Y\n" +
	"\x10redaction_config\x18\x01 \x01(\v2..cobaltspeech.privacyscreen.v1.RedactionConfigR\x0fredactionConfig\x12@\n" +
	"\x1cenable_unredacted_transcript\x18\x02 \x01(\bR\x1aenableUnredactedTranscript\"P\n" +
	"\vCustomClass\x12'\n" +
	"\x0fredaction_class\x18\x01 \x01(\tR\x0eredactionClass\x12\x18\n" +
	"\apattern\x18\x02 \x01(\tR\apattern\"\xec\x02\n" +
	"\x0fRedactionConfig\x12\x19\n" +
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12+\n" +
	"\x11redaction_classes\x18\x02 \x03(\tR\x10redactionClasses\x12+\n" +
	"\x11disable_streaming\x18\x03 \x01(\bR\x10disableStreaming\x12Q\n" +
	"\x0ecustom_classes\x18\x04 \x03(\v2*.cobaltspeech.privacyscreen.v1.CustomClassR\rcustomClasses\x12f\n" +
	"\x19custom_unredacted_classes\x18\x06 \x03(\v2*.cobaltspeech.privacyscreen.v1.CustomClassR\x17customUnredactedClasses\x12)\n" +
	"\x10disabled_classes\x18\x05 \x03(\tR\x0fdisabledClasses\"V\n" +
	"\n" +
	"Transcript\x12H\n" +
	"\n" +
	"utterances\x18\x01 \x03(\v2(.cobaltspeech.privacyscreen.v1.UtteranceR\n" +
	"utterances\"\xae\x01\n" +
	"\x1cTranscribeAndRedactUtterance\x12D\n" +
	"\bredacted\x18\x01 \x01(\v2(.cobaltspeech.privacyscreen.v1.UtteranceR\bredacted\x12H\n" +
	"\n" +
	"unredacted\x18\x02 \x01(\v2(.cobaltspeech.privacyscreen.v1.UtteranceR\n" +
	"unredacted\"\xd7\x01\n" +
	"\tUtterance\x12#\n" +
	"\raudio_channel\x18\x02 \x01(\rR\faudioChannel\x12\"\n" +
	"\rstart_time_ms\x18\x03 \x01(\x04R\vstartTimeMs\x12\x1f\n" +
	"\vduration_ms\x18\x04 \x01(\x04R\n" +
	"durationMs\x12%\n" +
	"\x0easr_confidence\x18\x05 \x01(\x01R\rasrConfidence\x129\n" +
	"\x05words\x18\a \x03(\v2#.cobaltspeech.privacyscreen.v1.WordR\x05words\"\x83\x02\n" +
	"\x04Word\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12%\n" +
	"\x0easr_confidence\x18\x02 \x01(\x01R\rasrConfidence\x12\"\n" +
	"\rstart_time_ms\x18\x03 \x01(\x04R\vstartTimeMs\x12\x1f\n" +
	"\vduration_ms\x18\x04 \x01(\x04R\n" +
	"durationMs\x12\x1f\n" +
	"\vis_redacted\x18\x05 \x01(\bR\n" +
	"isRedacted\x12'\n" +
	"\x0fredaction_class\x18\x06 \x01(\tR\x0eredactionClass\x121\n" +
	"\x14redaction_confidence\x18\a \x01(\x01R\x13redactionConfidence\"\xe2\x01\n" +
	"\rRedactedToken\x12#\n" +
	...
	"\x0fredaction_class\x18\x04 \x01(\tR\x0eredactionClass\x121\n" +
	"\x14redaction_confidence\x18\x05 \x01(\x01R\x13redactionConfidence2\xdd\x06\n" +
	"\x14PrivacyScreenService\x12j\n" +
	"\aVersion\x12-.cobaltspeech.privacyscreen.v1.VersionRequest\x1a..cobaltspeech.privacyscreen.v1.VersionResponse\"\x00\x12s\n" +
	"\n" +
	"ListModels\x120.cobaltspeech.privacyscreen.v1.ListModelsRequest\x1a1.cobaltspeech.privacyscreen.v1.ListModelsResponse\"\x00\x12s\n" +
	"\n" +
	"RedactText\x120.cobaltspeech.privacyscreen.v1.RedactTextRequest\x1a1.cobaltspeech.privacyscreen.v1.RedactTextResponse\"\x00\x12\x85\x01\n" +
	"\x10RedactTranscript\x126.cobaltspeech.privacyscreen.v1.RedactTranscriptRequest\x1a7.cobaltspeech.privacyscreen.v1.RedactTranscriptResponse\"\x00\x12\xb6\x01\n" +
	"\x1fStreamingRedactTranscribedAudio\x12E.cobaltspeech.privacyscreen.v1.StreamingRedactTranscribedAudioRequest\x1aF.cobaltspeech.privacyscreen.v1.StreamingRedactTranscribedAudioResponse\"\x00(\x010\x01\x12\xad\x01\n" +
	"\x1cStreamingTranscribeAndRedact\x12B.cobaltspeech.privacyscreen.v1.StreamingTranscribeAndRedactRequest\x1aC.cobaltspeech.privacyscreen.v1.StreamingTranscribeAndRedactResponse\"\x00(\x010\x01B\xa0\x02\n" +
	"!com.cobaltspeech.privacyscreen.v1B\x12PrivacyscreenProtoP\x01ZQgithub.com/cobaltspeech/go-genproto/cobaltspeech/privacyscreen/v1;privacyscreenv1\xa2\x02\x03CPX\xaa\x02\x1dCobaltspeech.Privacyscreen.V1\xca\x02\x1dCobaltspeech\\Privacyscreen\\V1\xe2\x02)Cobaltspeech\\Privacyscreen\\V1\\GPBMetadata\xea\x02\x1fCobaltspeech::Privacyscreen::V1b\x06proto3"
