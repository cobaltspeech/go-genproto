...
const (
	...
	VoiceBioService_VectorizeVoiceprints_FullMethodName = "/cobaltspeech.voicebio.v1.VoiceBioService/VectorizeVoiceprints"
	VoiceBioService_CompareVoiceprints_FullMethodName   = "/cobaltspeech.voicebio.v1.VoiceBioService/CompareVoiceprints"
)
...
type VoiceBioServiceClient interface {
	...
	VectorizeVoiceprints(ctx context.Context, in *VectorizeVoiceprintsRequest, opts ...grpc.CallOption) (*VectorizeVoiceprintsResponse, error)
	...
	CompareVoiceprints(ctx context.Context, in *CompareVoiceprintsRequest, opts ...grpc.CallOption) (*CompareVoiceprintsResponse, error)
}
...
func (c *voiceBioServiceClient) VectorizeVoiceprints(ctx context.Context, in *VectorizeVoiceprintsRequest, opts ...grpc.CallOption) (*VectorizeVoiceprintsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VectorizeVoiceprintsResponse)
	err := c.cc.Invoke(ctx, VoiceBioService_VectorizeVoiceprints_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *voiceBioServiceClient) CompareVoiceprints(ctx context.Context, in *CompareVoiceprintsRequest, opts ...grpc.CallOption) (*CompareVoiceprintsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CompareVoiceprintsResponse)
	err := c.cc.Invoke(ctx, VoiceBioService_CompareVoiceprints_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VoiceBioServiceServer interface {
	...
	// or as input features for other machine learning models. The specific format
	// and dimensionality of these vectors may vary depending on the model used.
	VectorizeVoiceprints(context.Context, *VectorizeVoiceprintsRequest) (*VectorizeVoiceprintsResponse, error)
	// Compares pre-extracted voiceprints and returns similarity scores and match
	// results without needing to send audio data. This is useful in cases where
	// the user wants to compare a given voiceprint against a large number of
	// other voiceprints, and sending audio data for each comparison would be
	...
	// `StreamingEnroll` method, and then use this method to compare it against a
	// large number of other voiceprints in batches.
	CompareVoiceprints(context.Context, *CompareVoiceprintsRequest) (*CompareVoiceprintsResponse, error)
...
func (UnimplementedVoiceBioServiceServer) StreamingEnroll(grpc.ClientStreamingServer[StreamingEnrollRequest, StreamingEnrollResponse]) error {
	return status.Error(codes.Unimplemented, "method StreamingEnroll not implemented")
}
func (UnimplementedVoiceBioServiceServer) StreamingVerify(grpc.ClientStreamingServer[StreamingVerifyRequest, StreamingVerifyResponse]) error {
	return status.Error(codes.Unimplemented, "method StreamingVerify not implemented")
}
func (UnimplementedVoiceBioServiceServer) StreamingIdentify(grpc.ClientStreamingServer[StreamingIdentifyRequest, StreamingIdentifyResponse]) error {
	return status.Error(codes.Unimplemented, "method StreamingIdentify not implemented")
}
func (UnimplementedVoiceBioServiceServer) VectorizeVoiceprints(context.Context, *VectorizeVoiceprintsRequest) (*VectorizeVoiceprintsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VectorizeVoiceprints not implemented")
}
func (UnimplementedVoiceBioServiceServer) CompareVoiceprints(context.Context, *CompareVoiceprintsRequest) (*CompareVoiceprintsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CompareVoiceprints not implemented")
}
...
func RegisterVoiceBioServiceServer(s grpc.ServiceRegistrar, srv VoiceBioServiceServer) {
	// If the following call panics, it indicates UnimplementedVoiceBioServiceServer was
...
func _VoiceBioService_VectorizeVoiceprints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VectorizeVoiceprintsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VoiceBioServiceServer).VectorizeVoiceprints(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VoiceBioService_VectorizeVoiceprints_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VoiceBioServiceServer).VectorizeVoiceprints(ctx, req.(*VectorizeVoiceprintsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _VoiceBioService_CompareVoiceprints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompareVoiceprintsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VoiceBioServiceServer).CompareVoiceprints(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VoiceBioService_CompareVoiceprints_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VoiceBioServiceServer).CompareVoiceprints(ctx, req.(*CompareVoiceprintsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VoiceBioService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VectorizeVoiceprints",
			Handler:    _VoiceBioService_VectorizeVoiceprints_Handler,
		},
		{
			MethodName: "CompareVoiceprints",
			Handler:    _VoiceBioService_CompareVoiceprints_Handler,
		},
	},
