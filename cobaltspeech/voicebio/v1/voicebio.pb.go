...
func (x *StreamingEnrollRequest) GetRequest() isStreamingEnrollRequest_Request {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *StreamingEnrollRequest) GetConfig() *EnrollmentConfig {
	if x != nil {
		if x, ok := x.Request.(*StreamingEnrollRequest_Config); ok {
			return x.Config
		}
	}
	return nil
...
func (x *StreamingEnrollRequest) GetAudio() *Audio {
	if x != nil {
		if x, ok := x.Request.(*StreamingEnrollRequest_Audio); ok {
			return x.Audio
		}
	}
	return nil
...
func (x *StreamingVerifyRequest) GetRequest() isStreamingVerifyRequest_Request {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *StreamingVerifyRequest) GetConfig() *VerificationConfig {
	if x != nil {
		if x, ok := x.Request.(*StreamingVerifyRequest_Config); ok {
			return x.Config
		}
	}
	return nil
...
func (x *StreamingVerifyRequest) GetAudio() *Audio {
	if x != nil {
		if x, ok := x.Request.(*StreamingVerifyRequest_Audio); ok {
			return x.Audio
		}
	}
	return nil
...
func (x *StreamingIdentifyRequest) GetRequest() isStreamingIdentifyRequest_Request {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *StreamingIdentifyRequest) GetConfig() *IdentificationConfig {
	if x != nil {
		if x, ok := x.Request.(*StreamingIdentifyRequest_Config); ok {
			return x.Config
		}
	}
	return nil
...
func (x *StreamingIdentifyRequest) GetAudio() *Audio {
	if x != nil {
		if x, ok := x.Request.(*StreamingIdentifyRequest_Audio); ok {
			return x.Audio
		}
	}
	return nil
...
type VectorizeVoiceprintsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// ID of the model to use for vectorization. The model used for vectorization must
	// match with the model used for enrollment of the voiceprints. A list of
	// supported IDs can be found using the `ListModels` call.
	ModelId string `protobuf:"bytes,1,opt,name=model_id,json=modelId,proto3" json:"model_id,omitempty"`
	// Voiceprints to be vectorized.
	Voiceprints   []*Voiceprint `protobuf:"bytes,2,rep,name=voiceprints,proto3" json:"voiceprints,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *VectorizeVoiceprintsRequest) Reset() {
	*x = VectorizeVoiceprintsRequest{}
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VectorizeVoiceprintsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VectorizeVoiceprintsRequest) ProtoMessage() {}

func (x *VectorizeVoiceprintsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VectorizeVoiceprintsRequest.ProtoReflect.Descriptor instead.
func (*VectorizeVoiceprintsRequest) Descriptor() ([]byte, []int) {
	return file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescGZIP(), []int{15}
}

func (x *VectorizeVoiceprintsRequest) GetModelId() string {
	if x != nil {
		return x.ModelId
	}
	return ""
...
func (x *VectorizeVoiceprintsRequest) GetVoiceprints() []*Voiceprint {
	if x != nil {
		return x.Voiceprints
	}
	return nil
...
type VectorizeVoiceprintsResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Voiceprint data converted into a vector representation, which can be used
	// for various downstream tasks such as clustering, visualization, or as input
	// features for other machine learning models. The specific format and
	// dimensionality of these vectors may vary depending on the model used.
	//
	// The order of this list is the same as the input voiceprint list provided in
	// the `VectorizeVoiceprintsRequest` message.
	Voiceprints   []*VectorVoiceprint `protobuf:"bytes,1,rep,name=voiceprints,proto3" json:"voiceprints,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *VectorizeVoiceprintsResponse) Reset() {
	*x = VectorizeVoiceprintsResponse{}
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VectorizeVoiceprintsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VectorizeVoiceprintsResponse) ProtoMessage() {}

func (x *VectorizeVoiceprintsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VectorizeVoiceprintsResponse.ProtoReflect.Descriptor instead.
func (*VectorizeVoiceprintsResponse) Descriptor() ([]byte, []int) {
	return file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescGZIP(), []int{16}
}

func (x *VectorizeVoiceprintsResponse) GetVoiceprints() []*VectorVoiceprint {
	if x != nil {
		return x.Voiceprints
	}
	return nil
...
type CompareVoiceprintsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// ID of the model to use for comparison. The model used for comparison must
	// match with the model used for enrollment of the voiceprints. A list of
	// supported IDs can be found using the `ListModels` call.
	ModelId string `protobuf:"bytes,1,opt,name=model_id,json=modelId,proto3" json:"model_id,omitempty"`
	// The voiceprint to compare against the reference voiceprints.
	TargetVoiceprint *Voiceprint `protobuf:"bytes,2,opt,name=target_voiceprint,json=targetVoiceprint,proto3" json:"target_voiceprint,omitempty"`
	// Voiceprints that should be compared against the target voiceprint.
	ReferenceVoiceprints []*Voiceprint `protobuf:"bytes,3,rep,name=reference_voiceprints,json=referenceVoiceprints,proto3" json:"reference_voiceprints,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}

func (x *CompareVoiceprintsRequest) Reset() {
	*x = CompareVoiceprintsRequest{}
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CompareVoiceprintsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompareVoiceprintsRequest) ProtoMessage() {}

func (x *CompareVoiceprintsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompareVoiceprintsRequest.ProtoReflect.Descriptor instead.
func (*CompareVoiceprintsRequest) Descriptor() ([]byte, []int) {
	return file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescGZIP(), []int{17}
}

func (x *CompareVoiceprintsRequest) GetModelId() string {
	if x != nil {
		return x.ModelId
	}
	return ""
...
func (x *CompareVoiceprintsRequest) GetTargetVoiceprint() *Voiceprint {
	if x != nil {
		return x.TargetVoiceprint
	}
	return nil
}

func (x *CompareVoiceprintsRequest) GetReferenceVoiceprints() []*Voiceprint {
	if x != nil {
		return x.ReferenceVoiceprints
	}
	return nil
}
...
type CompareVoiceprintsResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Index (0-based) of the best matching voiceprint in the list of reference
	// voiceprints provided in the `CompareVoiceprintsRequest` message. If none of
	// the voiceprints was a match, a negative value is returned.
	BestMatchIndex int32 `protobuf:"varint,1,opt,name=best_match_index,json=bestMatchIndex,proto3" json:"best_match_index,omitempty"`
	// Result of comparing the given the target voiceprint against each of the
	// reference voiceprints. The order of this list is the same as the reference
	// voiceprint list provided in the `CompareVoiceprintsRequest` message.
	VoiceprintComparisonResults []*VoiceprintComparisonResult `protobuf:"bytes,2,rep,name=voiceprint_comparison_results,json=voiceprintComparisonResults,proto3" json:"voiceprint_comparison_results,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}

func (x *CompareVoiceprintsResponse) Reset() {
	*x = CompareVoiceprintsResponse{}
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CompareVoiceprintsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompareVoiceprintsResponse) ProtoMessage() {}

func (x *CompareVoiceprintsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompareVoiceprintsResponse.ProtoReflect.Descriptor instead.
func (*CompareVoiceprintsResponse) Descriptor() ([]byte, []int) {
	return file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescGZIP(), []int{18}
}

func (x *CompareVoiceprintsResponse) GetBestMatchIndex() int32 {
	if x != nil {
		return x.BestMatchIndex
	}
	return 0
...
func (x *CompareVoiceprintsResponse) GetVoiceprintComparisonResults() []*VoiceprintComparisonResult {
	if x != nil {
		return x.VoiceprintComparisonResults
	}
	return nil
...
// representation.
type VectorVoiceprint struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// List of floating point values representing the voiceprint in vector form.
	Data          []float32 `protobuf:"fixed32,1,rep,packed,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *VectorVoiceprint) Reset() {
	*x = VectorVoiceprint{}
...
func (x *VectorVoiceprint) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VectorVoiceprint) ProtoMessage() {}

func (x *VectorVoiceprint) ProtoReflect() protoreflect.Message {
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VectorVoiceprint.ProtoReflect.Descriptor instead.
func (*VectorVoiceprint) Descriptor() ([]byte, []int) {
	return file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescGZIP(), []int{20}
}

func (x *VectorVoiceprint) GetData() []float32 {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *AudioFormat) Reset() {
	*x = AudioFormat{}
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AudioFormat) Descriptor() ([]byte, []int) {
	return file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescGZIP(), []int{21}
}

func (x *AudioFormat) GetAudioFormat() isAudioFormat_AudioFormat {
	if x != nil {
		return x.AudioFormat
	}
	return nil
...
func (x *AudioFormat) GetAudioFormatRaw() *AudioFormatRAW {
	if x != nil {
		if x, ok := x.AudioFormat.(*AudioFormat_AudioFormatRaw); ok {
...
func (x *AudioFormat) GetAudioFormatHeadered() AudioFormatHeadered {
	if x != nil {
		if x, ok := x.AudioFormat.(*AudioFormat_AudioFormatHeadered); ok {
...
func (x *AudioFormatRAW) Reset() {
	*x = AudioFormatRAW{}
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AudioFormatRAW) Descriptor() ([]byte, []int) {
	return file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescGZIP(), []int{22}
}
...
func (x *Audio) Reset() {
	*x = Audio{}
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Audio) Descriptor() ([]byte, []int) {
	return file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescGZIP(), []int{23}
}
...
func (x *Model) Reset() {
	*x = Model{}
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Model) Descriptor() ([]byte, []int) {
	return file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescGZIP(), []int{24}
}
...
func (x *ModelAttributes) Reset() {
	*x = ModelAttributes{}
	mi := &file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ModelAttributes) Descriptor() ([]byte, []int) {
	return file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescGZIP(), []int{25}
}
...
const file_cobaltspeech_voicebio_v1_voicebio_proto_rawDesc = "" +
	"\n" +
	"'cobaltspeech/voicebio/v1/voicebio.proto\x12\x18cobaltspeech.voicebio.v1\"\x10\n" +
	"\x0eVersionRequest\"+\n" +
	"\x0fVersionResponse\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\"\x13\n" +
	"\x11ListModelsRequest\"M\n" +
	"\x12ListModelsResponse\x127\n" +
	"\x06models\x18\x01 \x03(\v2\x1f.cobaltspeech.voicebio.v1.ModelR\x06models\"\xa2\x01\n" +
	"\x16StreamingEnrollRequest\x12D\n" +
	"\x06config\x18\x01 \x01(\v2*.cobaltspeech.voicebio.v1.EnrollmentConfigH\x00R\x06config\x127\n" +
	"\x05audio\x18\x02 \x01(\v2\x1f.cobaltspeech.voicebio.v1.AudioH\x00R\x05audioB\t\n" +
	"\arequest\"\xb8\x01\n" +
	"\x17StreamingEnrollResponse\x12D\n" +
	"\n" +
	"voiceprint\x18\x01 \x01(\v2$.cobaltspeech.voicebio.v1.VoiceprintR\n" +
	"voiceprint\x12W\n" +
	"\x11enrollment_status\x18\x02 \x01(\v2*.cobaltspeech.voicebio.v1.EnrollmentStatusR\x10enrollmentStatus\"\xce\x01\n" +
	"\x10EnrollmentConfig\x12\x19\n" +
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12H\n" +
	"\faudio_format\x18\x02 \x01(\v2%.cobaltspeech.voicebio.v1.AudioFormatR\vaudioFormat\x12U\n" +
	"\x13previous_voiceprint\x18\x03 \x01(\v2$.cobaltspeech.voicebio.v1.VoiceprintR\x12previousVoiceprint\"\x8e\x01\n" +
	"\x10EnrollmentStatus\x12/\n" +
	"\x13enrollment_complete\x18\x01 \x01(\bR\x12enrollmentComplete\x12I\n" +
	"!additional_audio_required_seconds\x18\x02 \x01(\rR\x1eadditionalAudioRequiredSeconds\"\xa4\x01\n" +
	"\x16StreamingVerifyRequest\x12F\n" +
	"\x06config\x18\x01 \x01(\v2,.cobaltspeech.voicebio.v1.VerificationConfigH\x00R\x06config\x127\n" +
	"\x05audio\x18\x02 \x01(\v2\x1f.cobaltspeech.voicebio.v1.AudioH\x00R\x05audioB\t\n" +
	"\arequest\"g\n" +
	"\x17StreamingVerifyResponse\x12L\n" +
	"\x06result\x18\x01 \x01(\v24.cobaltspeech.voicebio.v1.VoiceprintComparisonResultR\x06result\"b\n" +
	...
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12H\n" +
	"\faudio_format\x18\x02 \x01(\v2%.cobaltspeech.voicebio.v1.AudioFormatR\vaudioFormat\x12D\n" +
	"\n" +
	"voiceprint\x18\x03 \x01(\v2$.cobaltspeech.voicebio.v1.VoiceprintR\n" +
	"voiceprint\"\xa8\x01\n" +
	"\x18StreamingIdentifyRequest\x12H\n" +
	"\x06config\x18\x01 \x01(\v2..cobaltspeech.voicebio.v1.IdentificationConfigH\x00R\x06config\x127\n" +
	"\x05audio\x18\x02 \x01(\v2\x1f.cobaltspeech.voicebio.v1.AudioH\x00R\x05audioB\t\n" +
	"\arequest\"\xbf\x01\n" +
	"\x19StreamingIdentifyResponse\x12(\n" +
	"\x10best_match_index\x18\x01 \x01(\x05R\x0ebestMatchIndex\x12x\n" +
	"\x1dvoiceprint_comparison_results\x18\x02 \x03(\v24.cobaltspeech.voicebio.v1.VoiceprintComparisonResultR\x1bvoiceprintComparisonResults\"\xc3\x01\n" +
	"\x14IdentificationConfig\x12\x19\n" +
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12H\n" +
	"\faudio_format\x18\x02 \x01(\v2%.cobaltspeech.voicebio.v1.AudioFormatR\vaudioFormat\x12F\n" +
	"\vvoiceprints\x18\x03 \x03(\v2$.cobaltspeech.voicebio.v1.VoiceprintR\vvoiceprints\"\x80\x01\n" +
	"\x1bVectorizeVoiceprintsRequest\x12\x19\n" +
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12F\n" +
	"\vvoiceprints\x18\x02 \x03(\v2$.cobaltspeech.voicebio.v1.VoiceprintR\vvoiceprints\"l\n" +
	"\x1cVectorizeVoiceprintsResponse\x12L\n" +
	"\vvoiceprints\x18\x01 \x03(\v2*.cobaltspeech.voicebio.v1.VectorVoiceprintR\vvoiceprints\"\xe4\x01\n" +
	"\x19CompareVoiceprintsRequest\x12\x19\n" +
	"\bmodel_id\x18\x01 \x01(\tR\amodelId\x12Q\n" +
	"\x11target_voiceprint\x18\x02 \x01(\v2$.cobaltspeech.voicebio.v1.VoiceprintR\x10targetVoiceprint\x12Y\n" +
	"\x15reference_voiceprints\x18\x03 \x03(\v2$.cobaltspeech.voicebio.v1.VoiceprintR\x14referenceVoiceprints\"\xc0\x01\n" +
	"\x1aCompareVoiceprintsResponse\x12(\n" +
	"\x10best_match_index\x18\x01 \x01(\x05R\x0ebestMatchIndex\x12x\n" +
	"\x1dvoiceprint_comparison_results\x18\x02 \x03(\v24.cobaltspeech.voicebio.v1.VoiceprintComparisonResultR\x1bvoiceprintComparisonResults\" \n" +
	"\n" +
	"Voiceprint\x12\x12\n" +
	"\x04data\x18\x01 \x01(\tR\x04data\"&\n" +
	"\x10VectorVoiceprint\x12\x12\n" +
	"\x04data\x18\x01 \x03(\x02R\x04data\"\xd8\x01\n" +
	"\vAudioFormat\x12T\n" +
	"\x10audio_format_raw\x18\x02 \x01(\v2(.cobaltspeech.voicebio.v1.AudioFormatRAWH\x00R\x0eaudioFormatRaw\x12c\n" +
	"\x15audio_format_headered\x18\x03 \x01(\x0e2-.cobaltspeech.voicebio.v1.AudioFormatHeaderedH\x00R\x13audioFormatHeaderedB\x0e\n" +
	"\faudio_format\"\xf3\x01\n" +
	"\x0eAudioFormatRAW\x12C\n" +
	"\bencoding\x18\x01 \x01(\x0e2'.cobaltspeech.voicebio.v1.AudioEncodingR\bencoding\x12\x1b\n" +
	"\tbit_depth\x18\x02 \x01(\rR\bbitDepth\x12B\n" +
	"\n" +
	"byte_order\x18\x03 \x01(\x0e2#.cobaltspeech.voicebio.v1.ByteOrderR\tbyteOrder\x12\x1f\n" +
	"\vsample_rate\x18\x04 \x01(\rR\n" +
	"sampleRate\x12\x1a\n" +
	"\bchannels\x18\x05 \x01(\rR\bchannels\"\x1b\n" +
	"\x05Audio\x12\x12\n" +
	...
	"\n" +
	"attributes\x18\x03 \x01(\v2).cobaltspeech.voicebio.v1.ModelAttributesR\n" +
	"attributes\"2\n" +
	...
	"\x1eAUDIO_FORMAT_HEADERED_OGG_OPUS\x10\x042\xe7\x06\n" +
	"\x0fVoiceBioService\x12`\n" +
	"\aVersion\x12(.cobaltspeech.voicebio.v1.VersionRequest\x1a).cobaltspeech.voicebio.v1.VersionResponse\"\x00\x12i\n" +
	"\n" +
	"ListModels\x12+.cobaltspeech.voicebio.v1.ListModelsRequest\x1a,.cobaltspeech.voicebio.v1.ListModelsResponse\"\x00\x12z\n" +
	"\x0fStreamingEnroll\x120.cobaltspeech.voicebio.v1.StreamingEnrollRequest\x1a1.cobaltspeech.voicebio.v1.StreamingEnrollResponse\"\x00(\x01\x12z\n" +
	"\x0fStreamingVerify\x120.cobaltspeech.voicebio.v1.StreamingVerifyRequest\x1a1.cobaltspeech.voicebio.v1.StreamingVerifyResponse\"\x00(\x01\x12\x80\x01\n" +
	"\x11StreamingIdentify\x122.cobaltspeech.voicebio.v1.StreamingIdentifyRequest\x1a3.cobaltspeech.voicebio.v1.StreamingIdentifyResponse\"\x00(\x01\x12\x87\x01\n" +
	"\x14VectorizeVoiceprints\x125.cobaltspeech.voicebio.v1.VectorizeVoiceprintsRequest\x1a6.cobaltspeech.voicebio.v1.VectorizeVoiceprintsResponse\"\x00\x12\x81\x01\n" +
	"\x12CompareVoiceprints\x123.cobaltspeech.voicebio.v1.CompareVoiceprintsRequest\x1a4.cobaltspeech.voicebio.v1.CompareVoiceprintsResponse\"\x00B\xf8\x01\n" +
	"\x1ccom.cobaltspeech.voicebio.v1B\rVoicebioProtoP\x01ZGgithub.com/cobaltspeech/go-genproto/cobaltspeech/voicebio/v1;voicebiov1\xa2\x02\x03CVX\xaa\x02\x18Cobaltspeech.Voicebio.V1\xca\x02\x18Cobaltspeech\\Voicebio\\V1\xe2\x02$Cobaltspeech\\Voicebio\\V1\\GPBMetadata\xea\x02\x1aCobaltspeech::Voicebio::V1b\x06proto3"

var (
	file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescOnce sync.Once
	file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescData []byte
)
...
func file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescGZIP() []byte {
	file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescOnce.Do(func() {
		file_cobaltspeech_voicebio_v1_voicebio_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cobaltspeech_voicebio_v1_voicebio_proto_rawDesc), len(file_cobaltspeech_voicebio_v1_voicebio_proto_rawDesc)))
	})
...
var file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_cobaltspeech_voicebio_v1_voicebio_proto_goTypes = []any{
	...
	(*VectorizeVoiceprintsRequest)(nil),  // 18: cobaltspeech.voicebio.v1.VectorizeVoiceprintsRequest
	(*VectorizeVoiceprintsResponse)(nil), // 19: cobaltspeech.voicebio.v1.VectorizeVoiceprintsResponse
	(*CompareVoiceprintsRequest)(nil),    // 20: cobaltspeech.voicebio.v1.CompareVoiceprintsRequest
	(*CompareVoiceprintsResponse)(nil),   // 21: cobaltspeech.voicebio.v1.CompareVoiceprintsResponse
	(*Voiceprint)(nil),                   // 22: cobaltspeech.voicebio.v1.Voiceprint
	(*VectorVoiceprint)(nil),             // 23: cobaltspeech.voicebio.v1.VectorVoiceprint
	(*AudioFormat)(nil),                  // 24: cobaltspeech.voicebio.v1.AudioFormat
	(*AudioFormatRAW)(nil),               // 25: cobaltspeech.voicebio.v1.AudioFormatRAW
	(*Audio)(nil),                        // 26: cobaltspeech.voicebio.v1.Audio
	(*Model)(nil),                        // 27: cobaltspeech.voicebio.v1.Model
	(*ModelAttributes)(nil),              // 28: cobaltspeech.voicebio.v1.ModelAttributes
}
var file_cobaltspeech_voicebio_v1_voicebio_proto_depIdxs = []int32{
	27, // 0: cobaltspeech.voicebio.v1.ListModelsResponse.models:type_name -> cobaltspeech.voicebio.v1.Model
	9,  // 1: cobaltspeech.voicebio.v1.StreamingEnrollRequest.config:type_name -> cobaltspeech.voicebio.v1.EnrollmentConfig
	26, // 2: cobaltspeech.voicebio.v1.StreamingEnrollRequest.audio:type_name -> cobaltspeech.voicebio.v1.Audio
	22, // 3: cobaltspeech.voicebio.v1.StreamingEnrollResponse.voiceprint:type_name -> cobaltspeech.voicebio.v1.Voiceprint
	...
	24, // 5: cobaltspeech.voicebio.v1.EnrollmentConfig.audio_format:type_name -> cobaltspeech.voicebio.v1.AudioFormat
	22, // 6: cobaltspeech.voicebio.v1.EnrollmentConfig.previous_voiceprint:type_name -> cobaltspeech.voicebio.v1.Voiceprint
	14, // 7: cobaltspeech.voicebio.v1.StreamingVerifyRequest.config:type_name -> cobaltspeech.voicebio.v1.VerificationConfig
	26, // 8: cobaltspeech.voicebio.v1.StreamingVerifyRequest.audio:type_name -> cobaltspeech.voicebio.v1.Audio
	...
	24, // 10: cobaltspeech.voicebio.v1.VerificationConfig.audio_format:type_name -> cobaltspeech.voicebio.v1.AudioFormat
	22, // 11: cobaltspeech.voicebio.v1.VerificationConfig.voiceprint:type_name -> cobaltspeech.voicebio.v1.Voiceprint
	17, // 12: cobaltspeech.voicebio.v1.StreamingIdentifyRequest.config:type_name -> cobaltspeech.voicebio.v1.IdentificationConfig
	26, // 13: cobaltspeech.voicebio.v1.StreamingIdentifyRequest.audio:type_name -> cobaltspeech.voicebio.v1.Audio
	...
	24, // 15: cobaltspeech.voicebio.v1.IdentificationConfig.audio_format:type_name -> cobaltspeech.voicebio.v1.AudioFormat
	22, // 16: cobaltspeech.voicebio.v1.IdentificationConfig.voiceprints:type_name -> cobaltspeech.voicebio.v1.Voiceprint
	22, // 17: cobaltspeech.voicebio.v1.VectorizeVoiceprintsRequest.voiceprints:type_name -> cobaltspeech.voicebio.v1.Voiceprint
	23, // 18: cobaltspeech.voicebio.v1.VectorizeVoiceprintsResponse.voiceprints:type_name -> cobaltspeech.voicebio.v1.VectorVoiceprint
	22, // 19: cobaltspeech.voicebio.v1.CompareVoiceprintsRequest.target_voiceprint:type_name -> cobaltspeech.voicebio.v1.Voiceprint
	22, // 20: cobaltspeech.voicebio.v1.CompareVoiceprintsRequest.reference_voiceprints:type_name -> cobaltspeech.voicebio.v1.Voiceprint
	13, // 21: cobaltspeech.voicebio.v1.CompareVoiceprintsResponse.voiceprint_comparison_results:type_name -> cobaltspeech.voicebio.v1.VoiceprintComparisonResult
	25, // 22: cobaltspeech.voicebio.v1.AudioFormat.audio_format_raw:type_name -> cobaltspeech.voicebio.v1.AudioFormatRAW
	2,  // 23: cobaltspeech.voicebio.v1.AudioFormat.audio_format_headered:type_name -> cobaltspeech.voicebio.v1.AudioFormatHeadered
	1,  // 24: cobaltspeech.voicebio.v1.AudioFormatRAW.encoding:type_name -> cobaltspeech.voicebio.v1.AudioEncoding
	0,  // 25: cobaltspeech.voicebio.v1.AudioFormatRAW.byte_order:type_name -> cobaltspeech.voicebio.v1.ByteOrder
	28, // 26: cobaltspeech.voicebio.v1.Model.attributes:type_name -> cobaltspeech.voicebio.v1.ModelAttributes
	3,  // 27: cobaltspeech.voicebio.v1.VoiceBioService.Version:input_type -> cobaltspeech.voicebio.v1.VersionRequest
	5,  // 28: cobaltspeech.voicebio.v1.VoiceBioService.ListModels:input_type -> cobaltspeech.voicebio.v1.ListModelsRequest
	7,  // 29: cobaltspeech.voicebio.v1.VoiceBioService.StreamingEnroll:input_type -> cobaltspeech.voicebio.v1.StreamingEnrollRequest
	11, // 30: cobaltspeech.voicebio.v1.VoiceBioService.StreamingVerify:input_type -> cobaltspeech.voicebio.v1.StreamingVerifyRequest
	15, // 31: cobaltspeech.voicebio.v1.VoiceBioService.StreamingIdentify:input_type -> cobaltspeech.voicebio.v1.StreamingIdentifyRequest
	18, // 32: cobaltspeech.voicebio.v1.VoiceBioService.VectorizeVoiceprints:input_type -> cobaltspeech.voicebio.v1.VectorizeVoiceprintsRequest
	20, // 33: cobaltspeech.voicebio.v1.VoiceBioService.CompareVoiceprints:input_type -> cobaltspeech.voicebio.v1.CompareVoiceprintsRequest
	4,  // 34: cobaltspeech.voicebio.v1.VoiceBioService.Version:output_type -> cobaltspeech.voicebio.v1.VersionResponse
	6,  // 35: cobaltspeech.voicebio.v1.VoiceBioService.ListModels:output_type -> cobaltspeech.voicebio.v1.ListModelsResponse
	8,  // 36: cobaltspeech.voicebio.v1.VoiceBioService.StreamingEnroll:output_type -> cobaltspeech.voicebio.v1.StreamingEnrollResponse
	12, // 37: cobaltspeech.voicebio.v1.VoiceBioService.StreamingVerify:output_type -> cobaltspeech.voicebio.v1.StreamingVerifyResponse
	16, // 38: cobaltspeech.voicebio.v1.VoiceBioService.StreamingIdentify:output_type -> cobaltspeech.voicebio.v1.StreamingIdentifyResponse
	19, // 39: cobaltspeech.voicebio.v1.VoiceBioService.VectorizeVoiceprints:output_type -> cobaltspeech.voicebio.v1.VectorizeVoiceprintsResponse
	21, // 40: cobaltspeech.voicebio.v1.VoiceBioService.CompareVoiceprints:output_type -> cobaltspeech.voicebio.v1.CompareVoiceprintsResponse
...
func file_cobaltspeech_voicebio_v1_voicebio_proto_init() {
	...
	file_cobaltspeech_voicebio_v1_voicebio_proto_msgTypes[21].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cobaltspeech_voicebio_v1_voicebio_proto_rawDesc), len(file_cobaltspeech_voicebio_v1_voicebio_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   26,
			NumExtensions: 0,
			NumServices:   1,
